...
for measure_indx = 1 : length (measure_names)
    ...
    switch measure_names{measure_indx}
        ...
        case 'gc'
            ...
            [results.GC_x2_to_x1_model.S_r,results.GC_x2_to_x1_model.det_S_r,results.GC_x2_to_x1_model.trace_S_r,...
                results.GC_x2_to_x1_model.prod_diag_S_r,results.GC_x2_to_x1_model.A_r,results.GC_x2_to_x1_model.SIG_r,...
            ...
            [results.GC_x1_to_x2_model.S_r,results.GC_x1_to_x2_model.det_S_r,results.GC_x1_to_x2_model.trace_S_r,...
                results.GC_x1_to_x2_model.prod_diag_S_r,results.GC_x1_to_x2_model.A_r,results.GC_x1_to_x2_model.SIG_r,...
                results.GC_x1_to_x2_model.masked_Delta] = get_reduced_S_from_autoCov(X,...
                split_mask_A,split_mask_E,max_order,freq_res,iter_max,gamma,min_error);
